...
if(isset($_POST['verify'])){
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'purandlaharipujitha@gmail.com'; // Your email
        $mail->Password = 'gaqa fooo hmhj ogfx'; // Use App Password if using Gmail
        $mail->SMTPSecure = 'ssl';
        $mail->Port = 465;
        ...
        $_SESSION['name']=$name;
        $mail->setFrom('purandlaharipujitha@gmail.com');
        $mail->addAddress($_POST['email']); // Recipient email
        $mail->Subject = 'OTP for registration';
        $a=rand(10000,99999);
        $mail->Body    = "
        <p><strong>Dear {$name},</strong></p>
        <p>Thank you for registering with <strong>Your EZ Mart Store</strong>! To complete your registration, please use the following <strong>One-Time Password (OTP):</strong></p>
